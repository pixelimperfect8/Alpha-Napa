...
export default function SplitScreen() {
    ...
    const highlights = [
        "Small cohort of founding families",
        "2 hours of AI-powered academics daily",
        "Afternoons for real-world skills & projects",
        "Campus in Napa Valley",
    ];
    ...
    return (
        <section className="w-full flex flex-col md:flex-row min-h-screen bg-[#1c1b19] text-[#FDFBF7] rounded-b-[2.5rem]" id="community">
            ...
            <div className="w-full md:w-1/2 flex flex-col p-8 md:p-16 justify-center">
                ...
                {/* What to Expect */}
                <div className="mb-16">
                    <h3 className="font-mono text-xs tracking-widest text-[#8A7B66] uppercase mb-8">
                        What to Expect
                    </h3>
                    <div className="flex flex-col gap-4">
                        {highlights.map((item, i) => (
                            ...
                            >
                                <div className="w-1.5 h-1.5 rounded-full bg-[#8A7B66] shrink-0" />
                                <span className="text-lg md:text-xl font-heading font-medium text-[#FDFBF7]/90">
                                    {item}
                                </span>
                            </motion.div>
                        ))}
                ...
                <div className="border-t border-white/10 pt-8 mb-16">
                    <div className="flex items-baseline gap-4 mb-4">
                        <h3 className="text-3xl md:text-4xl font-heading font-semibold text-[#8A7B66] leading-none">Founding Families</h3>
                    </div>
                    <p className="text-white/50 font-body font-light leading-relaxed max-w-md mb-3">
                        Standard tuition: TBD at full launch.
                    </p>
                    <p className="text-white/70 font-body font-light leading-relaxed max-w-md">
                        Founding families receive a <span className="text-white font-medium">permanent $10,000 discount per child</span>.
                    </p>
                </div>
