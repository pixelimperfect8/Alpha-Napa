...
const traits = [
    ...
    { num: "03", title: "Real Skills", desc: "Those who value real-world application, quests, and apprenticeships over standardized testing." },
...
export default function WhoThisIsFor() {
    ...
    // Track scroll progress purely within this massive container
    const { scrollYProgress } = useScroll({ target: targetRef });

    // Map 0-1 vertical scroll to 0 to -75% horizontal scroll (4 items => 400vw => -300vw max shift = -75%)
    ...
    return (
        <section ref={targetRef} className="relative h-[400vh] bg-[#1c1b19] text-[#FDFBF7]" id="who-this-is-for">
            <div className="sticky top-0 flex h-screen items-center overflow-hidden">
                ...
                {/* Intro absolute text pinned to top */}
